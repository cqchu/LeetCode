...
skipB = 3
Output: Reference of the node with value = 8 Input Explanation: The
...
= 1
Output: Reference of the node with value = 2 Input Explanation: The
intersected node's value is 2 (note that this must not be 0 if the two lists
intersect). From the head of A, it reads as [1,9,1,2,4]. From the head of B, it
...
structure. Each value on each linked list is in the range [1, 10^9]. Your code
