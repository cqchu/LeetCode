...
public:
    /*
    bool recurse(string &s1, string &s2, string &s3, int ptr1, int ptr2, int ptr3) {
        // some stop condition
    ...
    */
    bool isInterleave(string s1, string s2, string s3) {
        ...
        dp[0][0] = true;    // dp[i][j] represent the first-(i+j) char of s3 can be formed
                            //by the interleaving of first-i char of s1 and first-j char of s2   
