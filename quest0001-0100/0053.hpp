...
//     // divide and conquer
//     void div(int startPos, int endPos, vector<int>& nums, int& lIdx, int&
//     rIdx, int& value) {
//         if (endPos <= startPos)
//             return;
...
//         findMaxCrossSubarray(startPos, endPos, nums, crossLIdx, crossRIdx,
//         crossValue);
...
//     void findMaxCrossSubarray(int startPos, int endPos, vector<int>& nums,
//     int& lIdx, int& rIdx, int& value) {
//         int midPos = (startPos + endPos) / 2;
//         lIdx = rIdx = midPos;
